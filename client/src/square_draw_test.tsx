...
describe('square_draw', function() {
  ...
  it('SquareElem', function() {
    ...
    assert.deepStrictEqual(
        ...
        <td className="square-solid pink" style={{width: '100px', height: '100px'}}
            onClick={ignoreClick}> </td>);

    const S1 = split(solid("pink"), solid("orange"), solid("yellow"), solid("green"));
    assert.deepStrictEqual(
        SquareNodeElem({square: S1, width: 100n, height: 100n, path: nil}),
        <td className="square-split"><table cellSpacing={0}>
          <tbody>
            <tr>
              <SquareNodeElem square={solid("pink")} width={50n} height={50n}
    ...
    const S2 = split(solid("pink"), solid("orange"), solid("yellow"),
    ...
    assert.deepStrictEqual(
        ...
        <td className="square-split"><table cellSpacing={0}>
          <tbody>
            <tr>
              <SquareNodeElem square={solid("pink")} width={100n} height={100n}
            ...
            <tr>
              ...
              <SquareNodeElem square={split(solid("pink"), solid("orange"), solid("yellow"), solid("green"))}
